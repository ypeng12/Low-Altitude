...
### 4. Multi-Stage Low-Altitude Domain Lexicon Discovery Pipeline ($N=18$ Core Words) ⭐ *(CORE PAPER CONTRIBUTION)*
...
│
├── 📍 Stage 3: Expert Manual Quality & Domain Filter ────────────────── -8 words
│              (Manual removal of 8 general evaluative terms: unforgettable, unique, incredibly, plenty, cheaper, smoother, convenient, handy)
│
└── 🏆 Stage 4: Final Core Low-Altitude Domain Discovery Lexicon ──────── 18 words ⭐ (CORE DISCOVERY)
               ...
               └── 💰 Booking & Expectation Match (2 words): forward, reasonable
```

$$\mathbf{145 \text{ (Stage 1 Gaps)}} \xrightarrow{\text{VADER Audit}} 26 \text{ (Dual Misses)} \xrightarrow{\text{Expert Manual Filter}} \mathbf{18 \text{ Core Discovery Words}}$$

---

### 📂 Official Saved Dataset Artifacts:
* 👉 **Master 18 Low-Altitude Domain Discovery Lexicon (Excel)**: [`data/analyze/final_18_domain_discovery_words.xlsx`](file:///Users/yuliangpeng/Desktop/Low-Altitude/data/analyze/final_18_domain_discovery_words.xlsx)
* 👉 **Master 18 Low-Altitude Domain Discovery Lexicon (CSV)**: [`data/analyze/final_18_domain_discovery_words.csv`](file:///Users/yuliangpeng/Desktop/Low-Altitude/data/analyze/final_18_domain_discovery_words.csv)
